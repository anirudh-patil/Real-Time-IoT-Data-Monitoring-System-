...
|---|---|---|
| [`/Data-Logger-Dashboard`](./Data-Logger-Dashboard/Spike_Frontend) | React 19 + TanStack Router/Query dashboard, real-time charts, admin panel | [frontend/README.md](./Data-Logger-Dashboard/Spike_Frontend/README.md) |
| [`/Data-Logger-Backend`](./Data-Logger-Backend/Spike_backend) | Node.js/Express API — auth, devices, telemetry, alerts, webhooks, WebSocket | [backend/README.md](./Data-Logger-Backend/Spike_backend/README.md) |
| [`/ESP-workspace`](./Data-Logger-ESP-workspace) | ESP32 sketch — UART ingestion from STM32, NTP time sync, MQTT/TLS publish to AWS IoT Core | [esp32-firmware/README.md](./Data-Logger-ESP-workspace/README.md) |
| [`STM32-Workspace`](./Data-Logger-Data-Acquisition-using-STM32-Workspace) | STM32 sensor sampling + framed serial protocol to the ESP32 | [stm32-firmware/README.md](./Data-Logger-Data-Acquisition-using-STM32-Workspace/README.md) |
